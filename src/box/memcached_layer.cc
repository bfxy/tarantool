...
int
memcached_process_delete(struct memcached_connection *con)
{
	/* default declarations */
	struct memcached_hdr  *h = con->hdr;
	struct memcached_body *b = &con->body;
...
int
memcached_process_noop(struct memcached_connection *con)
{
	/* default declarations */
	struct memcached_hdr  *h = con->hdr;
	struct obuf *out = &(con->iobuf->out);
...
int
memcached_process_verbosity(struct memcached_connection *con)
{
	/* default declarations */
	struct memcached_hdr  *h = con->hdr;
	struct memcached_body *b = &con->body;
...
static inline void
memcached_process_stat_reset(struct memcached_connection *con)
{
	memset(&con->cfg->stat, 0, sizeof(struct memcached_stat));
}

static inline void
memcached_process_stat_all(struct memcached_connection *con)
{
...
int
memcached_process_stat(struct memcached_connection *con)
{
	/* default declarations */
	struct memcached_body *b = &con->body;
	...
	/* ADD errstr for TODO */
	if (b->key_len == 0) {
		memcached_process_stat_all(con);
	} else if (b->key_len == 5  && strcmp(b->key, "reset")) {
		memcached_process_stat_reset(con);
...
const mc_process_func_t mc_handler[] = {
	memcached_process_get,         /* MEMCACHED_BIN_CMD_GET      , 0x00 */
	memcached_process_set,         /* MEMCACHED_BIN_CMD_SET      , 0x01 */
	memcached_process_set,         /* MEMCACHED_BIN_CMD_ADD      , 0x02 */
	memcached_process_set,         /* MEMCACHED_BIN_CMD_REPLACE  , 0x03 */
	memcached_process_delete,      /* MEMCACHED_BIN_CMD_DELETE   , 0x04 */
	memcached_process_delta,       /* MEMCACHED_BIN_CMD_INCR     , 0x05 */
	memcached_process_delta,       /* MEMCACHED_BIN_CMD_DECR     , 0x06 */
	memcached_process_quit,        /* MEMCACHED_BIN_CMD_QUIT     , 0x07 */
	memcached_process_flush,       /* MEMCACHED_BIN_CMD_FLUSH    , 0x08 */
	memcached_process_get,         /* MEMCACHED_BIN_CMD_GETQ     , 0x09 */
	memcached_process_noop,        /* MEMCACHED_BIN_CMD_NOOP     , 0x0a */
	memcached_process_version,     /* MEMCACHED_BIN_CMD_VERSION  , 0x0b */
	memcached_process_get,         /* MEMCACHED_BIN_CMD_GETK     , 0x0c */
	memcached_process_get,         /* MEMCACHED_BIN_CMD_GETKQ    , 0x0d */
	memcached_process_pend,        /* MEMCACHED_BIN_CMD_APPEND   , 0x0e */
	memcached_process_pend,        /* MEMCACHED_BIN_CMD_PREPEND  , 0x0f */
	memcached_process_stat,        /* MEMCACHED_BIN_CMD_STAT     , 0x10 */
	memcached_process_set,         /* MEMCACHED_BIN_CMD_SETQ     , 0x11 */
	memcached_process_set,         /* MEMCACHED_BIN_CMD_ADDQ     , 0x12 */
	memcached_process_set,         /* MEMCACHED_BIN_CMD_REPLACEQ , 0x13 */
	memcached_process_delete,      /* MEMCACHED_BIN_CMD_DELETEQ  , 0x14 */
	memcached_process_delta,       /* MEMCACHED_BIN_CMD_INCRQ    , 0x15 */
	memcached_process_delta,       /* MEMCACHED_BIN_CMD_DECRQ    , 0x16 */
	memcached_process_quit,        /* MEMCACHED_BIN_CMD_QUITQ    , 0x17 */
	memcached_process_flush,       /* MEMCACHED_BIN_CMD_FLUSHQ   , 0x18 */
	memcached_process_pend,        /* MEMCACHED_BIN_CMD_APPENDQ  , 0x19 */
	memcached_process_pend,        /* MEMCACHED_BIN_CMD_PREPENDQ , 0x1a */
	memcached_process_verbosity,   /* MEMCACHED_BIN_CMD_VERBOSITY, 0x1b */
	memcached_process_gat,         /* MEMCACHED_BIN_CMD_TOUCH    , 0x1c */
	memcached_process_gat,         /* MEMCACHED_BIN_CMD_GAT      , 0x1d */
	memcached_process_gat,         /* MEMCACHED_BIN_CMD_GATQ     , 0x1e */
	...
	memcached_process_gat,         /* MEMCACHED_BIN_CMD_GATK     , 0x23 */
	memcached_process_gat,         /* MEMCACHED_BIN_CMD_GATKQ    , 0x24 */
